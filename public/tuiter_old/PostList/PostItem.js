...
<div class ="row">
        <div class="col-2">
           <img src = ${posts.avatarIcon} class="rounded-circle wd-img wd-img-width-all"/>
        </div>

    <div class="col-8 d-inline wd-user">
        <div class ="col">
        <div class ="wd-caption">
        <p class = "fw-bold d-inline wd-white">${posts.userName}</p><i class="fa fa-check-circle wd-white d-inline p-2"></i>
        <p class = "wd-grey d-inline">${posts.handle}</p>
        <p class = "d-inline wd-grey">-${posts.time}</p>

        </div>
        </div>
        <div class ="wd-caption">
        <p class ="wd-white wd-caption-width">${posts.caption}</p>
        </div>
    </div>
    <div class ="col-2">
    ...
    ${posts.title === ''?
                        `<div class="wd-main-img-three position-relative">
                         <img src = ${posts.image} class="wd-main-img-two"/>
                         </div>` :
                        `<div class="wd-main-img position-relative">
                             <img src = ${posts.image} class="wd-main-img-one img-fluid"/>
                             </div>
                             <div class ="wd-content-title">
                             <p class ="wd-title wd-white">${posts.title}</p>
                             <p class ="wd-content wd-grey">${posts.content}<?p>
                             </div>
                         `}
